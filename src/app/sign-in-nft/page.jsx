        ...
        <div className={styles.main}>
                ...
                <div className={styles["sign-in-form"]}>
                    ...
                    <div className={styles["email-container"]}>
                        ...
                        <div className={styles["input-content"]}>
                            <input className={styles["input"]} type="text" placeholder='debra.holt@example.com' />
                            <img className={styles["input-image"]} src="/assets-sign-in-nft/images/X Icon.svg" alt="Email input" />
                        </div>
                    </div>
                    <div className={styles["password-container"]}>
                        ...
                        <div className={styles["input-content"]}>
                            <input className={styles["input"]} type="password" value='12345678' />
                            <img className={styles["input-image"]} src="/assets-sign-in-nft/images/Hide Icon.svg" alt="Email input" />
                        </div>
                    </div>
            ...
            <div className={styles["image-section"]}>
                <div className={styles["image-container"]}>
                    <img className={styles["image-container__image"]} src="/assets-sign-in-nft/images/DRIP_20.png" alt="PNFT Market" />
                </div>
            </div>
        </div>
    )
